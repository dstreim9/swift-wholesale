  ...
  return (
    <div className="flex-1 overflow-auto px-6 py-6">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-xl font-bold text-foreground mb-1">Bedrijfsinformatie</h1>
        <p className="text-sm text-muted-foreground mb-6">Vul je bedrijfsgegevens in voor je bestellingen.</p>
        ...
        <div className="bg-card rounded-xl border p-6 space-y-6">
          ...
          <Button onClick={handleSave} className="wholesale-gradient border-0" disabled={saving}>
