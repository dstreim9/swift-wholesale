...
const OrderDocumentPage = () => {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      ...
      {/* Document preview */}
      <div className="flex-1 overflow-auto bg-muted/30 print:bg-white print:overflow-visible">
        <div
          ref={printRef}
          className="max-w-[960px] mx-auto my-8 bg-white shadow-lg rounded-lg print:shadow-none print:rounded-none print:my-0 print:max-w-none"
        >
          {activeTab === "confirmation" ? (
